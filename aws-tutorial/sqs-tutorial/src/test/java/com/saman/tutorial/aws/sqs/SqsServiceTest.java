...
import static com.saman.tutorial.aws.sqs.TestServiceFactory.createS3Facade;
import static com.saman.tutorial.aws.sqs.utils.IoUtils.createFile;
...
class SqsServiceTest {
    ...
    @BeforeAll
    static void setUp() {
        underTest = Try.of(() -> createS3Facade(new SqsClientFactory(TestEnv.loadAccountProperties())))
